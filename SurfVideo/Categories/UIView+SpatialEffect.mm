...
- (void)setFrame:(CGRect)frame {
    ...
    auto topGradientLayer = static_cast<CAGradientLayer *>(objc_getAssociatedObject(backdropLayer, ns_SpatialEffect::topGradientLayerKey));
    ...
    auto leftGradientLayer = static_cast<CAGradientLayer *>(objc_getAssociatedObject(backdropLayer, ns_SpatialEffect::leftGradientLayerKey));
    ...
    auto rightGradientLayer = static_cast<CAGradientLayer *>(objc_getAssociatedObject(backdropLayer, ns_SpatialEffect::rightGradientLayerKey));
    rightGradientLayer.frame = CGRectMake(CGRectGetMaxX(bounds) * 0.95f,
                                          CGRectGetMinY(bounds) + CGRectGetHeight(bounds) * 0.05f,
                                          CGRectGetWidth(bounds) * 0.05f,
                                          CGRectGetHeight(bounds) * 0.9f);
    
    auto bottomGradientLayer = static_cast<CAGradientLayer *>(objc_getAssociatedObject(backdropLayer, ns_SpatialEffect::bottomGradientLayerKey));
    ...
    auto topLeftGradientLayer = static_cast<CAGradientLayer *>(objc_getAssociatedObject(backdropLayer, ns_SpatialEffect::topLeftGradientLayerKey));
    topLeftGradientLayer.frame = CGRectMake(CGRectGetMinX(bounds),
                                            CGRectGetMinY(bounds),
                                            CGRectGetWidth(bounds) * 0.05f,
                                            CGRectGetHeight(bounds) * 0.05f);
    
    auto topRightGradientLayer = static_cast<CAGradientLayer *>(objc_getAssociatedObject(backdropLayer, ns_SpatialEffect::topRightGradientLayerKey));
    topRightGradientLayer.frame = CGRectMake(CGRectGetMinX(bounds) + CGRectGetWidth(bounds) * 0.95f,
                                             CGRectGetMinY(bounds),
                                             CGRectGetWidth(bounds) * 0.05f,
                                             CGRectGetHeight(bounds) * 0.05f);
    
    auto bottomRightGradientLayer = static_cast<CAGradientLayer *>(objc_getAssociatedObject(backdropLayer, ns_SpatialEffect::bottomRightGradientLayerKey));
    bottomRightGradientLayer.frame = CGRectMake(CGRectGetMinX(bounds) + CGRectGetWidth(bounds) * 0.95f,
                                                CGRectGetMinY(bounds) + CGRectGetHeight(bounds) * 0.95f,
                                                CGRectGetWidth(bounds) * 0.05f,
                                                CGRectGetHeight(bounds) * 0.05f);
    
    auto bottomLeftGradientLayer = static_cast<CAGradientLayer *>(objc_getAssociatedObject(backdropLayer, ns_SpatialEffect::bottomLeftGradientLayerKey));
    bottomLeftGradientLayer.frame = CGRectMake(CGRectGetMinX(bounds),
                                               CGRectGetMinY(bounds) + CGRectGetHeight(bounds) * 0.95f,
                                               CGRectGetWidth(bounds) * 0.05f,
                                               CGRectGetHeight(bounds) * 0.05f);
    
    auto centerLayer = static_cast<CALayer *>(objc_getAssociatedObject(backdropLayer, ns_SpatialEffect::centerLayerKey));
    centerLayer.frame = CGRectMake(CGRectGetMinX(bounds) + CGRectGetWidth(bounds) * 0.05f,
                                   CGRectGetMinY(bounds) + CGRectGetHeight(bounds) * 0.05f,
                                   CGRectGetWidth(bounds) * 0.9f,
                                   CGRectGetHeight(bounds) * 0.9f);
    
    auto gradientLayerMask = static_cast<CALayer *>(objc_getAssociatedObject(backdropLayer, ns_SpatialEffect::gradientLayerMaskKey));
...
- (void)sv_setSpatialEffect:(BOOL)sv_spatialEffect {
    ...
    if (sv_spatialEffect) {
        ...
        [blurFilter setValue:@3.f forKey:@"inputRadius"];
...
//            blurFilter
        ...
        objc_setAssociatedObject(backdropLayer, ns_SpatialEffect::topGradientLayerKey, topGradientLayer, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
        ...
        objc_setAssociatedObject(backdropLayer, ns_SpatialEffect::leftGradientLayerKey, leftGradientLayer, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
        ...
        objc_setAssociatedObject(backdropLayer, ns_SpatialEffect::rightGradientLayerKey, rightGradientLayer, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
        ...
        objc_setAssociatedObject(backdropLayer, ns_SpatialEffect::bottomGradientLayerKey, bottomGradientLayer, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
        ...
        objc_setAssociatedObject(backdropLayer, ns_SpatialEffect::topLeftGradientLayerKey, topLeftGradientLayer, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
        ...
        objc_setAssociatedObject(backdropLayer, ns_SpatialEffect::topRightGradientLayerKey, topRightGradientLayer, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
        ...
        objc_setAssociatedObject(backdropLayer, ns_SpatialEffect::bottomRightGradientLayerKey, bottomRightGradientLayer, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
        ...
        objc_setAssociatedObject(backdropLayer, ns_SpatialEffect::bottomLeftGradientLayerKey, bottomLeftGradientLayer, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
        
        CALayer *centerLayer = [CALayer new];
        centerLayer.backgroundColor = UIColor.blackColor.CGColor;
        objc_setAssociatedObject(backdropLayer, ns_SpatialEffect::centerLayerKey, centerLayer, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
        ...
        objc_setAssociatedObject(backdropLayer, ns_SpatialEffect::gradientLayerMaskKey, gradintLayerMask, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
